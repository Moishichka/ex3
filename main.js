...
const feedbackFormPopup = document.getElementById('feedback-form-popup');

orderButton.addEventListener('click', () => {
  popupProductList.style.display = 'none';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const name_rtInput = document.getElementById("name_r");
  ...
  form.addEventListener("submit", async (event) => {
    ...
    if (lastnameInput.value === "" || emailInput.value === "" || firstnameInput === "" || phoneInput.value === "" || addressInput.value === "") {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        if (name_rtInput.value === "" || reviewInput.value === "") {
            alert("Все поля должны быть заполнены");
        } else {
